...
const MemberModal: React.FC<MemberModalProps> = ({
  ...
  const handleAddMember = () => {
    ...
    const newMember: BoardMember = {
      ...
      name: email.split("@")[0],
      email,
      role: "EDITOR", // default role when inviting
    };
  ...
  const changeRole = (userId: string, role: BoardRole) => {
    onUpdateBoard({
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-md rounded-xl shadow-2xl flex flex-col overflow-hidden">
              ...
              >
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-bold text-gray-900 truncate">
                      ...
                      {member.userId === board.ownerId && (
                        <span className="text-[10px] bg-yellow-100 text-yellow-700 px-1 rounded ml-1 font-normal">
                          Owner
                        </span>
                      )}
                    </p>
                ...
                <div className="flex items-center gap-2">
                  <select
                    ...
                    value={member.role}
                    onChange={(e) =>
                      changeRole(member.userId, e.target.value as BoardRole)
                    }
        ...
        <div className="p-4 bg-gray-50 text-[10px] text-gray-400 border-t flex flex-col gap-1">
          <p>
            <strong>Owner:</strong> Can manage members and edit all tasks.
          </p>
          <p>
            <strong>Editor:</strong> Can edit and move tasks.
          </p>
          <p>
